                        ...
                        <Card style={styles.headingCard}>
                            <CardItem style={styles.headingCardItem}>
                                <View style={styles.headerButtonInfo}>
                                    <Text style={styles.optionHeading}>Step 1 </Text>
                                    <Text style={styles.optionSubHeading}>Select a category</Text>
                        ...
                        <ScrollView>
                            ...
                            <List>
                                ...
                                {categories.data.map((value, key) => (
                                    <ListItem key={key}>
                                        <TouchableOpacity style={styles.listButton} onPress={() => this.props.navigation.navigate('SubCategoryChooser', { category: value })}>
